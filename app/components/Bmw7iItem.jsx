...
const Bmw7iItem = () => {
  return (
    <div className="mx-6">
      ...
      <p>
        Available with luxury leather interior and long wheel based options, it
        means the passenger has ample leg room to sit back in space and be
      ...
      <div className="mt-12 ">
        <div className="flex items-center gap-1  py-2">
          ...
          <span className="text-sm font-normal text-neutral-600">Extended rear leg room</span>
        </div>
      ...
      <div className="px-2 mt-7"><SwiperFleetItem/></div>
