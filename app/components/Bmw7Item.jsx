  ...
  return (
    <main className="mx-6">
      <article itemScope itemType="https://schema.org/Product">
        ...
        <meta itemProp="model" content="7 Series" />
        
        <div className="w-full py-7">
          <Image
            src="/images/cars/bmw7series/main.jpeg"
            alt="BMW 7 Series luxury sedan - exterior view"
            width={600}
            height={600}
            style={{ objectFit: "cover" }}
            priority={true}
            itemProp="image"
            aria-labelledby="bmw7-heading"
          />
        </div>
        
        <header className="pt-7 flex flex-col gap-7">
          <h1 id="bmw7-heading" className="text-2xl font-bold text-gray-900" itemProp="name">BMW 7 Series Overview</h1>
          ...
          <p className="text-gray-700" itemProp="description">
            ...
            luxury car of choice. The BMW 7 Series is a line of full-size luxury
          ...
          <p className="text-gray-700">
            ...
            The BMW 7 Series comes equipped with these premium features:
          </p>
        </header>
        
        <section aria-labelledby="features-heading">
          <h2 id="features-heading" className="sr-only">BMW 7 Series Features</h2>
        ...
        <div className="px-2 mt-7">
          <SwiperFleetItem listcars={bmw7cars} />
          <CarsOptions />
        </div>
      </article>
    </main>
